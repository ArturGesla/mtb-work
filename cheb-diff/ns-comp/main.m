...
% system("rotst -mode 3 -nx 150 -nz 40 -contipath 4 20 100 200 500");
...
% a=importdata("u500-150-40.dat");  a2=loadrs2(a,150,40);
...
%%
clf; 
% a=a0; mesh(a.xc,a.zc,a.u); hold on;
%  mesh(bx,bz,bu);
 mesh(b2x,b2z,b2u);
%%
clf; hold on; grid on;
...
% a=a2; contour(a.xu(1,:),a.zc(:,1),a.u(:,1:end-1),[-1:0.2:1],'k')
% a=a3; contour(a.xu(1,:),a.zc(:,1),a.u(:,1:end-1),[-1:0.2:1],'b')
% a=a0; contour(a.xc(1,:),a.zw(:,1),a.w(1:end-1,:),[-0.2:0.02:0.1],'c')
% a=a1; contour(a.xc(1,:),a.zw(:,1),a.w(1:end-1,:),[-0.2:0.02:0.1],'r')
% a=a2; contour(a.xc(1,:),a.zw(:,1),a.w(1:end-1,:),[-0.2:0.02:0.1],'k')
