...
for ix=1:length(x)
    ...
    %
    close all;mesh(x,z,phi);
    title("Analytical solution vth of Stokes problem | n modes: "+num2str(nmax));
    exportgraphics(gcf,"vthStokes"+num2str(nmax)+".png","Resolution",150)
