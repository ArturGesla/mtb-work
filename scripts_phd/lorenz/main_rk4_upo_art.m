...
np=100;
dt=1.5586/np;
[T,X]=rk4(@odefun,round(np)+1,dt,0,[-6.2262;-11.0027;13.0515],r,b,sigma);
...
% du=bicgstab(-J,g,1e-10,60);
 ...
 %% in r
 plot3(uMC(1:neq:end-1,:),uMC(2:neq:end-1,:),(uMC(3:neq:end-1,1)*0+1)*rM)
 %%
