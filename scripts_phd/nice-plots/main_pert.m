...
%%
for i=25:130
a=read_sunfluidh_data(i); vss=vssH-a.W;  r=a.yc(1:size(vss,2)); r=r./max(r)*10; z=a.xc(1:size(vss,1)); z=z./max(z); t=a.time; time=t;
label="u_{\theta}-u_{\theta,steady}";
a=(vss(180,:)); main_range;
%
close all;
