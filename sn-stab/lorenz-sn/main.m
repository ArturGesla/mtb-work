...
% np=52; r=24; nt=15;
 ...
 % r=24; nt=20; np=40*nt; x0=[ 10.135982315094342  10.189521543725682  25.691556187487929]; T=0.6779; T= 0.6803;
 % r=28; nt=20; np=40*nt; x0=[ 15.46726314426282  15.467263144262825  36.545259643893161]; T=1.558652210716179;
...
save("spectrumSNLorenz-"+num2str(nt)+".mat","evs2","nt","om","u","evc","evs");
