...
mult=10;
ie=3;
% plot(u(1:neq:end-1)+mult*real(evc(1:neq:end,ie)),u(2:neq:end-1)+mult*real(evc(2:neq:end,ie)));
% plot([u(1:neq:end-1),u(1:neq:end-1)+mult*real(evc(1:neq:end,ie))]',[u(2:neq:end-1), u(2:neq:end-1)+mult*real(evc(2:neq:end,ie))]');
